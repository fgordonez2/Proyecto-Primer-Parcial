...
*- Conocer el funcionamiento del proyecto led nocturno automático, con la ayuda de la ingenieria inversa para conocer caracteristicas y que aporta cada elemento usado para que el circuito funcione de una manera eficiente y correcta.*
